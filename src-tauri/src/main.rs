...
use serde::Serialize;
use torrent_config::RqbitDesktopConfig;
...
struct StateShared {
    config: torrent_config::RqbitDesktopConfig,
    api: Option<Api>,
}
...
#[tauri::command]
fn config_default() -> torrent_config::RqbitDesktopConfig {
    torrent_config::RqbitDesktopConfig::default()
}
