    ...
    <div className="grid items-center gap-4 px-4 py-2 border border-gray-200 rounded-lg bg-gray-50 dark:border-gray-800 dark:bg-gray-900">
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-xs font-medium">
          ...
          mollitia reiciendis odio laudantium veritatis, eaque eos qui voluptate
          corporis deleniti minima animi consequatur fugit suscipit libero sint
          nulla, maiores omnis. Veniam distinctio officia quis incidunt, in
          asperiores?
        </p>
      </div>
