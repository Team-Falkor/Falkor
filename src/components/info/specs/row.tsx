...
import { scrapeOptions } from '@/utils';
import { FC } from 'react';

type RequirementsRowProps = Data;

const RequirementsRow: FC<RequirementsRowProps> = ({ type, data }) => {
  if (!data) return null;
  ...
  return (
    <ul className="w-1/2 py-4 bg-white border-gray-200 divide-gray-200 rounded-lg dark:divide-gray-700 dark:border-gray-700 dark:bg-muted dark:text-gray-100">
      <h3 className="p-4 pt-1 pb-2 text-lg font-bold leading-6 capitalize text-primary">{type}</h3>
